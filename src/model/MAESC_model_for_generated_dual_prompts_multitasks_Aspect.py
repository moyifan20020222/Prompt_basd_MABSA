...
from src.model.modules_for_prompt_multitasks import MultiModalBartEncoder, MultiModalBartDecoder_span, Span_loss, \
    ...
    MultiModalBartDecoder_generate_aspect_prompt, MultiModalBartDecoder_MLM
...
class MultiModalBartModel_AESC(PretrainedBartModel):
    ...
    def prepare_state(self,
        ...
        generated_aspect_prompt, diversity_loss_aspect, l2_reg_loss_aspect = self.aspect_prompt_decoder(
        ...
        # import ipdb; ipdb.set_trace()
        if self.use_multitasks:
            aspects_num_loss, predict_aspects_num_logits, diversity_loss_aspect_num, l2_reg_loss_aspect_num = self.aspect_num_decoder(
        ...
        loss = [diversity_loss, l2_reg_loss, diversity_loss_aspect, l2_reg_loss_aspect, diversity_loss_aspect_num, l2_reg_loss_aspect_num]
    ...
    def forward(
        ...
        state, aspects_num_loss, predict_aspects_num, pseudo_loss, loss = self.prepare_state(
            input_ids,
            image_features,
            attention_mask,
            aesc_infos,
