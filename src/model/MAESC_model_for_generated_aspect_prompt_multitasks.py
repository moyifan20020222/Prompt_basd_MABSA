...
class MultiModalBartModel_AESC(PretrainedBartModel):
    ...
    def prepare_state(self,
        ...
        generated_prompt, diversity_loss, l2_reg_loss = self.prompt_decoder(
        ...
        diversity_loss_aspect_num = 0.0
        l2_reg_loss_aspect_num = 0.0
        # import ipdb; ipdb.set_trace()
        if self.use_multitasks:  # 用于预测Aspect的数量
            aspects_num_loss, predict_aspects_num_logits, _, _ = self.aspect_num_decoder(aspects_num_labels=aspects_num,
        ...
        loss = [diversity_loss, l2_reg_loss, diversity_loss_aspect_num, l2_reg_loss_aspect_num]
