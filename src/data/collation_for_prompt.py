...
class Collator:
    ...
    def __call__(self, batch):
        ...
        # 现在选用的是 tokenization_new_for_generated_prompt的函数，它并没有use_caption字段 Caption直接由数据集给出
        # print("图片描述字段", image_caption)
        ...
        # 新增一个部分，增加代码需要单独拿出文本嵌入部分，encoded['sentence_mask'] 指示了整个生成Prompt的文本部分
