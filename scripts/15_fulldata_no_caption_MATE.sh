...
do
    ...
    do
        ...
        do
            ...
            do
                for Prompt_pool_num in 8
                do
                CUDA_VISIBLE_DEVICES=1 python twitter_ae_training_for_generated_prompt_multitasks.py \
                        --dataset twitter15 src/data/jsons/few_shot_for_prompt/twitter_2015/twitter15_full_data_no_caption.json \
                        --checkpoint_dir ./ \
                        --model_config data/bart-base/config.json \
                        --log_dir log_for_generated_aspect_prompt_multitasks/15_full_data_no_caption_${sl}_${num_image_tokens}_${Prompt_pool_num}_ae \
                        --num_beams 4 \
                        --eval_every 1 \
                        --lr ${sl} \
                        --batch_size 12 \
