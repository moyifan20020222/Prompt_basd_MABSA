        ...
        do
            ...
            do
                ...
                CUDA_VISIBLE_DEVICES=3 python twitter_ae_training_for_generated_prompt_multitasks.py \
                        --dataset twitter17 src/data/jsons/few_shot_for_prompt/twitter_2017/twitter17_full_data.json \
                        --checkpoint_dir ./ \
                        --model_config data/bart-base/config.json \
                        --log_dir log_for_generated_aspect_prompt_multitasks/17_full_data_${sl}_${num_image_tokens}_${Prompt_pool_num}_ae \
                        --num_beams 4 \
                        --eval_every 1 \
                        --lr ${sl} \
                        --batch_size 4 \
