...
------------------
5.19
目前三个任务在 GMP 给出的Few-Shot 数据集下的最优值分别如下：（twitter17所需的Prompt池大小更大一些）
| MASC任务       | 准确率（%） | 训练时间（分） | 备注          |
|:--------------|------------:|:----------------:|---------------|
| Twitter15     |  72.73  |  42  | seed 13 num_image_token 2 PromptPoolNum 8 |
| Twitter17     |  69.71  |  33  | seed 100 num_image_token 2 PromptPoolNum 16 |


| MATE任务       | Precision（%） | Recall（%） | F1 (%)         |
|:--------------|------------:|:----------------:|---------------|
| Twitter15     |  78.08  |  71.46  | 74.62 |
| Twitter17     |  81.11  |  79.66  | 80.38 |


| MABSA任务       | Precision（%） | Recall（%） | F1 (%)         |
|:--------------|------------:|:----------------:|---------------|
| Twitter15     |  53.37  |  50.43  | 51.86 |
| Twitter17     |  57.25  |  53.40  | 55.26 |
